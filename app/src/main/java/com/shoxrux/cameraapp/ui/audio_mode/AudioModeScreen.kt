...
import com.shoxrux.cameraapp.ui.motion_detection.MotionDetectionScreenDirections
    ...
    private fun listenActions() {
        ...
        binding.nextBtn.setOnClickListener {
            ...
            if (binding.radioGroup.checkedRadioButtonId != -1) {
                changeScreen(AudioModeScreenDirections.actionAudioModeScreenToDeviceResolutionScreen())
            }

...
import com.shoxrux.cameraapp.databinding.HomeItemTopBinding
...
class HomeAdapter : RecyclerView.Adapter<HomeAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: HomeItemTopBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            HomeItemTopBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }
